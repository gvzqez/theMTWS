...
for x in range(0,len(List(35555).members)):
	...
	media_title = media.Media(
		...
		List(35555).members[x].poster.geturl().replace('original','w300_and_h450_bestv2'),     
...
for y in range(0,len(List(35556).members)):
	...
	media_title = media.Media(
		...
		List(35556).members[y].poster.geturl().replace('original','w300_and_h450_bestv2'),
...
for x in range(0,len(List(35558).members)):
	...
	media_title = media.Media(
		...
		List(35558).members[x].poster.geturl().replace('original','w300_and_h450_bestv2'),
...
for k in range(0,len(List(35557).members)):
	...
	media_title = media.Media(
		...
		List(35557).members[k].poster.geturl().replace('original','w300_and_h450_bestv2'),
